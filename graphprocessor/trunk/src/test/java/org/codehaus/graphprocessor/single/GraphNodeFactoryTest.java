...
import org.codehaus.graphprocessor.samples.nodefactory.TfSource1;
import org.codehaus.graphprocessor.samples.nodefactory.TfSource2;
import org.codehaus.graphprocessor.samples.nodefactory.TfSource3;
import org.codehaus.graphprocessor.samples.nodefactory.TfTarget1;
import org.codehaus.graphprocessor.samples.nodefactory.TfTarget2Factory;
...
public class GraphNodeFactoryTest
{
	...
	public void testFinder()
	{
		...
		NodeFactory nodeFactory = graph.getNodeConfig(TfSource2.class).getNodeFactory();
	...
	public void testFinder2()
	{
		...
		((DefaultBidiNodeConfig) graph.getNodeConfig(Tf2Source1.class)).setNodeFactory(new Tf2Target1Factory());
		...
		((DefaultBidiNodeConfig) graph.getNodeConfig(Tf2Source1.class)).setUidPropertyNames(null);
		((DefaultBidiNodeConfig) graph.getNodeConfig(Tf2Source1.class)).setNodeFactory(null);
	...
	public void testFinder3()
	{
		...
		((DefaultBidiNodeConfig) tree.getNodeConfig(TuUserDTO.class)).setUidPropertyNames("uid");
		((DefaultBidiNodeConfig) tree.getNodeConfig(TuUserDTO.class)).setNodeFactory(new TuUserModelFactory());
